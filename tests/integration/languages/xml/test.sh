...
run_test tractor test sample.xml -x "item" --expect 3 -m "finds all item elements"
run_test tractor test sample.xml -x "item[@type='feature']" --expect 2 -m "filters by attribute"
run_test tractor test sample.xml -x "item[@type='bug']" --expect 1 -m "finds bug items"
run_test tractor test sample.xml -x "setting" --expect 2 -m "finds setting elements"
