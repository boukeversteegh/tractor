...
echo "Go:"
run_test tractor sample.go -x "function" --expect 3 -m "func declarations become function elements"
...
run_test tractor sample.go -x "function[exported]" --expect 1 -m "exported functions have <exported/> marker"
run_test tractor sample.go -x "function[unexported]" --expect 2 -m "unexported functions have <unexported/> marker"
