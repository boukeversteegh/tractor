...
echo "TypeScript:"
run_test tractor sample.ts -x "function" --expect 3 -m "function declarations become function elements"
...
run_test tractor sample.ts -x "//param[optional]" --expect 1 -m "optional parameter has optional marker"
run_test tractor sample.ts -x "//param[not(optional)]" --expect 3 -m "required parameters have no optional marker"
