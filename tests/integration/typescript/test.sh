...
echo "TypeScript:"
run_test tractor sample.ts -x "function" --expect 4 -m "function declarations become function elements"
...
run_test tractor sample.ts -x "call" --expect 4 -m "call expressions renamed to call"
run_test tractor sample.ts -x "//param[optional]" --expect 2 -m "optional parameters have <optional/> marker"
run_test tractor sample.ts -x "//param[required]" --expect 5 -m "required parameters have <required/> marker"
