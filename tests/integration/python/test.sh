...
echo "Python:"
run_test tractor sample.py -x "function" --expect 3 -m "def statements become function elements"
...
run_test tractor sample.py -x "return" --expect 2 -m "return_statement renamed to return"
...
run_test tractor sample.py -x "function[async]" --expect 1 -m "async functions have <async/> marker"
