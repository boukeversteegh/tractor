...
pub const KINDS: &[KindEntry] = &[
    ...
    KindEntry { kind: "anonymous_function_creation_expression", handling: KindHandling::RenameWithMarker(FUNCTION, ANONYMOUS) },
    ...
    KindEntry { kind: "class_modifier",                handling: KindHandling::Custom },
    ...
    KindEntry { kind: "elseif_clause",                 handling: KindHandling::Rename(ELSE_IF) },
    ...
    KindEntry { kind: "exit_intrinsic",                handling: KindHandling::Rename(EXIT) },
