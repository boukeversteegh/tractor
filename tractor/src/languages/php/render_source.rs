//! PHP: tree → source code (canonical, no-anchor).
#![allow(dead_code)]
...
pub fn render(tree: &SyntaxTree) -> String {
    ...
    write_ir(tree, &mut out, Indent::SPACES_4, &php_syntax());
    out
}
...
fn php_syntax() -> Syntax {
    Syntax {
        ...
        return_keyword: "return", if_keyword: "if", elif_keyword: "elseif",
        else_keyword: "else", while_keyword: "while", for_keyword: "for",
        foreach_keyword: "foreach", foreach_in: " as ",
