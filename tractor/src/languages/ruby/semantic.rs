...
pub const KINDS: &[KindEntry] = &[
    ...
    KindEntry { kind: "method_call",                   handling: KindHandling::Rename(CALL) },
    ...
    KindEntry { kind: "next_statement",                handling: KindHandling::Rename(CONTINUE) },
    ...
    KindEntry { kind: "symbol",                        handling: KindHandling::Rename(SYMBOL) },
