...
fn csharp_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::distribute_member_list_attrs(
        xot, root,
        &["body", "block", "unit", "namespace", "section", "import", "tuple", "list", "dict", "array", "hash", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn rust_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "block", "file", "tuple", "list", "dict", "array", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn typescript_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "block", "program", "tuple", "list", "dict", "array", "hash", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn python_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::wrap_relationship_targets_in_type(xot, root)?;
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "module", "tuple", "list", "dict", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn go_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "file", "tuple", "list", "dict", "array", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn php_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::wrap_relationship_targets_in_type(xot, root)?;
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "namespace", "program", "tuple", "list", "dict", "array", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
...
fn ruby_post_transform(xot: &mut Xot, root: XotNode) -> Result<(), xot::Error> {
    ...
    crate::transform::distribute_member_list_attrs(
        xot, root, &["body", "program", "tuple", "list", "dict", "array", "hash", "pattern", "switch", "literal", "macro", "object", "template", "returns", "generator", "string", "type", "member", "select", "from"],
    )?;
    Ok(())
}
