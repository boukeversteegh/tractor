...
#[cfg(feature = "native")]
pub mod sql_to_json;
// SqlIr → canonical source string. Reconstructs syntactically valid
// SQL from the IR alone — no source byte ranges consulted. Locks
// down the principle that the IR captures every semantic distinction.
#[cfg(feature = "native")]
pub mod sql_canonical;
