...
use tractor::ir::{audit_coverage, lower_tsql_root, to_source};

#[test]
#[ignore]
fn tsql_missing_kinds() {
    let candidates = [
        "../tests/integration/languages/tsql/blueprint.sql",
        "tests/integration/languages/tsql/blueprint.sql",
    ];
