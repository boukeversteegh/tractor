  ...
  return (
    <DocLayout>
      ...
      <p className="doc-lead">
        HTML, CSS, and Markdown are parsed into a structure tree — similar to code, but with elements specific to each format.
      </p>

      <h2>HTML</h2>
      <p>
        HTML is parsed into a tree with <code>element</code>, <code>start_tag</code>, <code>tag_name</code>, <code>attribute</code>, and <code>text</code> nodes.
      </p>
      <Example
...
(use -d to increase depth, or -x to query specific elements)`}
      ...
      <h2>Markdown</h2>
      <p>
        Markdown is parsed into <code>section</code>, <code>heading</code>, <code>paragraph</code>, and <code>inline</code> nodes.
      </p>
      <Example
